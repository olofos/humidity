...
#define SLEEP_PERIOD_RETRY_REGISTRATION 30
#define SLEEP_PERIOD_SEND_MEASUREMENT 0
#define SLEEP_PERIOD_RETRY_MEASUREMENT 30
#define SLEEP_PERIOD_SEND_NEXT_MEASUREMENT 10
#define SLEEP_PERIOD_RESEND_MEASUREMENT 10
