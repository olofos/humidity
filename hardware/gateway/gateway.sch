...
U 1 1 5CF7B659
P 10700 2150
F 0 "Y1" H 10700 2300 50  0000 C CNN
F 1 "32768 - 6pF" H 10700 2000 50  0000 C CNN
F 2 "humidity:Crystal LFXTAL016178" H 10700 2150 50  0001 C CNN
F 3 "https://www.tme.eu/Document/1590aad5e7e715d4e1ddba2015ebdc85/LFXTAL016178Reel.pdf" H 10700 2150 50  0001 C CNN
F 4 "https://www.tme.eu/se/en/details/32.768k-85smxr/smd-quartz-crystals/iqd-frequency-products/lfxtal016178reel/" H 10700 2150 50  0001 C CNN "TME Link"
	1    10700 2150
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5CF7BB91
P 10600 1300
F 0 "BT1" V 10450 1300 50  0000 L CNN
F 1 "KEYS3001" V 10800 1300 50  0000 C CNN
F 2 "humidity:CR1216 Keystone 3001" V 10600 1360 50  0001 C CNN
F 3 "~" V 10600 1360 50  0001 C CNN
F 4 "https://www.tme.eu/se/en/details/keys3001/batteries-holders/keystone/3001/" V 10600 1300 50  0001 C CNN "TME Link"
	1    10600 1300
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CF7BDA8
P 9850 1400
F 0 "R15" V 9950 1400 50  0000 C CNN
F 1 "1k" V 9850 1400 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 9780 1400 50  0001 C CNN
...
U 1 1 5CF7C3FA
P 9750 2750
F 0 "#PWR023" H 9750 2500 50  0001 C CNN
...
U 1 1 5CF7CD47
P 10450 2800
F 0 "#PWR024" H 10450 2550 50  0001 C CNN
...
U 1 1 5CF7CD6C
P 10950 2800
F 0 "#PWR026" H 10950 2550 50  0001 C CNN
...
U 1 1 5CF7DB01
P 9450 1400
F 0 "C3" H 9500 1300 50  0000 L CNN
F 1 "100n" V 9300 1400 50  0000 C CNN
...
U 1 1 5CF7DF5B
P 9450 1650
F 0 "#PWR021" H 9450 1400 50  0001 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x06_P2.54mm_Vertical" H 1100 1300 50  0001 C CNN
...
F 2 "humidity:Adam_Tech_SMA_Female_RF2-19A" H 2800 5600 50  0001 C CNN
...
F 2 "humidity:FPC Connector 22 pins XF2M22151AR100" H 9500 4800 50  0001 C CNN
F 3 "~" H 9500 4800 50  0001 C CNN
F 4 "https://www.tme.eu/se/en/details/xf2m22151ar100/connectors-ffc-fpc-0-5mm/omron/" H 9500 4800 50  0001 C CNN "TME Link"
	1    9500 4800
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5D0AA536
P 9100 6150
F 0 "#PWR020" H 9100 5900 50  0001 C CNN
...
U 1 1 5D194E1E
P 8700 3800
F 0 "R14" H 8770 3846 50  0000 L CNN
...
U 1 1 5D38D843
P 7500 4050
F 0 "D2" H 7500 4150 50  0000 R CNN
...
U 1 1 5D395686
P 7500 4450
F 0 "R11" V 7400 4400 50  0000 L CNN
...
U 1 1 5D5915E6
P 8200 1800
F 0 "R12" V 8100 1800 50  0000 C CNN
...
U 1 1 5D59172D
P 8200 1550
F 0 "#PWR017" H 8200 1400 50  0001 C CNN
...
F 2 "LED_SMD:LED_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 7250 4050 50  0001 C CNN
...
U 1 1 5D657D92
P 7250 4450
F 0 "R8" V 7150 4400 50  0000 L CNN
...
U 1 1 5D6944F9
P 7450 2950
F 0 "R9" V 7500 2800 50  0000 C CNN
...
U 1 1 5D69464C
P 7450 3050
F 0 "R10" V 7500 2900 50  0000 C CNN
...
U 1 1 5D01B3AF
P 10250 900
F 0 "D3" H 10250 1000 50  0000 R CNN
F 1 "BAT54.215 " H 10250 800 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 10250 900 50  0001 C CNN
F 3 "https://www.tme.eu/Document/2c1c71bcfe5aad5e582fdc49c2dc275f/BAT54.215.pdf" H 10250 900 50  0001 C CNN
F 4 "https://www.tme.eu/se/en/details/bat54.215/smd-schottky-diodes/nexperia/" V 10250 900 50  0001 C CNN "TME Link"
	1    10250 900 
	1    0    0    -1  
$EndComp
Wire Wire Line
